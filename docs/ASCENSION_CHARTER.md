# Project Ascension — The Standing Charter

> Source: `Project_Ascension_Full_Game_Master_Prompt.md` (Part A, Sections 1–15, plus Appendices A–C). This file is the authoritative charter for the build. It is imported by the root `CLAUDE.md` and is therefore in force in every session. Do not edit it without a `docs/DECISIONS.md` entry.
